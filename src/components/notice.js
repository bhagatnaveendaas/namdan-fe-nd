...
const PopupNotice = (props) => {
    ...
    const [isHavingUserConsentInput, setIsHavingUserConsentInput] =
        useState(false);
    ...
    useEffect(() => {
        setNoticeMessage(props.message);
        setIsHavingUserConsentInput(props.requireUserConsent);
        setIsFailedState(props.isFailedState);
        setCustomStyles(props.styles);
