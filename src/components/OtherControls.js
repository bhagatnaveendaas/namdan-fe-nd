...
export default function OtherControls() {
  return (
    <View style={[theme.card, { backgroundColor: '#E0F8FC', flexDirection: 'row', paddingVertical: '4%' }]}>
      <View style={{
        width: '50%', flexDirection: 'row', paddingHorizontal: '5%', paddingLeft: '7%', alignSelf: 'center', alignContent: 'center', alignItems: 'center', justifyContent: 'space-between', borderRightColor: theme.colors.grey, borderRightWidth: 1
      }}
      >
        <View>
      ...
      <View style={{
        width: '50%', flexDirection: 'row', paddingHorizontal: '5%', paddingLeft: '7%', alignSelf: 'center', alignContent: 'center', alignItems: 'center', justifyContent: 'space-between',
      }}
      >
        <View>
          <Text style={{ fontWeight: 'bold', fontSize: 16 }}>Manage</Text>
