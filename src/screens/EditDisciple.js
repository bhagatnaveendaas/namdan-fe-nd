...
const SignUp = ({ navigation, route }) => {
    ...
    const formFields = {
        ...
        guardianName: user?.guardian_name || "", // TODO: gurardianName can be changed to guardian_name, validation sequence is not working for guardian_name
        address: user?.address || "",
        aadhaar_no: user?.unique_id || "",
        country_id: user?.country_id || 0,
        state_id: user?.state_id || 0,
        district_id: user?.district_id || 0,
        tehsil_id: user?.tehsil_id || 0,
        city_id: user?.city_id || 0,
        form_no: user?.form_no || 0,
        form_date: user?.form_date || "",
        ...
        dob: user?.dob || "",
        namdan_taken: user?.namdan_taken || "",
        namdan_center_name: user?.namdan_center_name || "",
        country_code: user?.country_code || "+91",
        whatsapp_country_code: user?.whatsapp_country_code || "+91",
        hajri: user?.satnam_attendance || [],
        satnam_date: user?.satnam_date || "",
        satnam_exam: user?.satnam_exam || [],
        sarnam_date: user?.sarnam_date || "",
        sarshabd_date: user?.sarshabd_date || "",
        shuddhikaran: user?.shuddhikaran || [],
    };
        ...
        >
            ...
            <View>
                <DatePicker
                    ...
                    appendComponent={
                        <>
                            {userData.satnam_date !== user.satnam_date && (
                                <TouchableOpacity
