...
const verifyOtp = () => (
  <View style={{
    backgroundColor: theme.colors.white, flex: 1, paddingHorizontal: '5%', paddingTop: '35%'
  }}
  >
    ...
    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly' }}>
      <View style={{
        backgroundColor: theme.colors.grey, borderRadius: 10, width: '19%', padding: '5%', alignContent: 'center', alignItems: 'center', alignSelf: 'center'
      }}
      >
