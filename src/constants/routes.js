...
export const createSadasyataUrl = "/sadasyata/create";
...
export const editSadasyataUrl = (id) => `/sadasyata/${id}/edit`;
...
export const deleteSadasyataUrl = (id) => `/sadasyata/${id}/delete`;
